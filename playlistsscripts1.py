...
# Example of scheduling the scripts
schedule.every().day.at("10:00").do(run_script, script_path="path_to_first_script.py")
schedule.every().day.at("12:00").do(run_script, script_path="path_to_second_script.py")
schedule.every().day.at("14:00").do(run_script, script_path="path_to_third_script.py")
